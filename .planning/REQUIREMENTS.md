...
- [ ] **MKT-04**: Plugin git tag `v2.0.0` annotated. Pushed to remote. (Operator-gated: awaits LAUNCH SCHEDULED — CI green + push prerequisites met 2026-07-03. Do NOT auto-stamp complete.)
