...
key-decisions:
  ...
  - "Hardcoded live Pixel ID '<pixel-id-redacted>' in facebook-purchase-tracking.js line 21 flagged in Section 2 as a D-26 sweep concern; strip removes it for free as a side-effect of file deletion. Inventory does NOT call for a separate D-26 history-rewrite — the credential is in the theme repo's git history, not the plugin repo's, and the theme is private + not subject to the public-flip per CONTEXT D-26 'Theme PII NOT in scope'."
