...
final class LangKeyCoverageTest extends MetapixelTestCase
{
    ...
    public function test_required_phase_4_keys_exist_in_en(): void
    {
        ...
        $arRequiredKeys = [
            ...
            'failed_events.column_replayed_at',
            'failed_events.status_needs_replay',
            'failed_events.filter_replayed',
            'failed_events.button_replay',
            'failed_events.button_check_dedup',
            'failed_events.tooltip_replay',
            'failed_events.dq_title',
            'failed_events.help_window',
